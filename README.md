# Pariksit Coaching Institute — Web Platform

A modern, high-performance web platform for **Pariksit Coaching Institute**, a premier JEE & NEET academy in Rourkela, Odisha.

> **Crafted & Contributed with Pride by a Student of Pariksit.**
...
- **Interactive Admissions Counseling**: Accessible dropdowns, direct WhatsApp chat, and Google Maps integration.

---

## 📁 Repository Structure
```text
pariksit-coaching-website/
├── index.html                  # Main application entry point
├── css/
│   └── glassmorphism.css       # Unified design system & responsive styling
├── js/
│   ├── data.js                 # Structured records (faculty, results, metrics)
...
## 📜 License & Attribution
Designed & developed as a student contribution for **Pariksit Incorporation India Private Limited**.
